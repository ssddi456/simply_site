<div style="
    ...
    <div class="nav">
      <div class="nav-button bg-main"><a href="{#$index_page#}">MAIN</a></div>
      <div class="nav-button bg-courses"><a href="{#$course_page#}">COURSES</a></div>
      <div class="nav-button bg-trainers"><a href="{#$teacher_page#}">TRAINERS</a></div>
