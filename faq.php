<?php 
	...
	$faqs = array(
						...
						array('title'=>'How long does each training programme last?', 'descript'=>'The average duration of a Business Focus corporate training programme is 50-60 hours. We can however also arrange programmes of different lengths depending on client preferences.'),
						array('title'=>'How do you organize trainees\'classes?', 'descript'=>'Business Focus utilizes a placement test to assess the trainees real English level. The Oxford Placement Test assesses students in reading and listening. This allows us to stream group classes so that all learners have similar weaknesses and strengths, thus allowing the class to progress together.')
					);
